...
|---|---|
| `blog` / `voice-doc-repo` / CV / LinkedIn | `voice_rules.py` banned words + KEEP_LIST; `iamhoi` / `iamhoi-skipend` marker wrapping; `check-ai-writing-tells.py` exit 0 |
...
**Evidence**: eBay store username, UserHome paths, and business strategies leaked in ebay-seller-tool (2026-04-11), required manual scrub + force-push.
