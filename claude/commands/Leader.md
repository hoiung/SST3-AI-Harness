...
- [ ] **Mirror-lane Lane A + Lane B exit 0** — `propagate-template.py --all --dry-run` AND `propagate-mirrors.py --dry-run --validate` both exit 0 (or skip-clean if no canonical-mirrored surface touched).
